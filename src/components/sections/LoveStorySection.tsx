...
const LOVE_STORY_ICONS = {
  Users: getLucideIcon("Users"),
  MessageCircle: getLucideIcon("MessageCircle"),
  Heart: getLucideIcon("Heart"),
  Gem: getLucideIcon("Gem"),
  PartyPopper: getLucideIcon("PartyPopper"),
} as const;
        ...
        <div className="relative max-w-lg mx-auto">
          ...
          <div className="space-y-6 md:space-y-0">
            {loveStory.map((item, index) => {
              const Icon =
                LOVE_STORY_ICONS[item.icon as keyof typeof LOVE_STORY_ICONS];
              ...
              return (
                <motion.div
                  ...
                  whileInView="visible"
                  viewport={{ once: true }}
                  className={`relative flex items-start gap-3 md:gap-0 md:items-center md:mb-10 ${
